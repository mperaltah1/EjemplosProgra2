...
import com.umg.employeesample.classes.Manager;
import com.umg.employeesample.classes.Secretary;
...
public class Salaries extends javax.swing.JFrame {
    ...
    private void buildAndAddEmployee(EmployeeType type, String sDpi, String name, String sHours) {
        int dpi = Integer.parseInt(sDpi);
        int hours = Integer.parseInt(sHours);
        Employee emp = switch (type) {
            case MANAGER ->
                new Manager(dpi, name, hours);
            case EXECUTIVE ->
                new Executive(dpi, name, hours);
            case DEVELOPER ->
                new Developer(dpi, name, hours);
            case SECRETARY ->
                new Secretary(dpi, name, hours);
            case ACCOUNTANT ->
                new Accountant(dpi, name, hours);
    ...
    private void addToModel(Employee emp) {
        ...
        dataColumns[2] = emp.getType().getLabel();
    ...
    private void initComponents() {
        ...
        cmbEmpType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gerente", "Ejecutivo", "Programador", "Secretaria", "Contador" }));
    ...
    private void btnCalculateSalaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalculateSalaryActionPerformed
        ...
        buildAndAddEmployee(type, txtDpi.getText(), txtName.getText(), txtHours.getText());
    ...
    private void btnCargaMasivaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargaMasivaActionPerformed
        ...
        try (Scanner sc = new Scanner(f)) {
            cleanTable();
            sc.nextLine(); //para ignorar la primera linea 
            while (sc.hasNextLine()) {
                String line = sc.nextLine();
                String[] data = line.split(",");
                EmployeeType type = EmployeeType.valueOf(data[2]);
                buildAndAddEmployee(type, data[0], data[1], data[3]);
            }
